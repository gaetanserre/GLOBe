...
class Langevin(Particles_Optimizer):
    """
    Interface for the Langevin optimizer with optional particle filtering.
    ...
    def __init__(
        ...
        super().__init__("Langevin", bounds, filter_type=filter_type, verbose=verbose)
        self.c_opt = C_Langevin(
            bounds, n_particles, iter, dt, beta, batch_size, self.filter_type
        )
